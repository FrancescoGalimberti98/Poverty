...
q = ggplot(data = data[indice,], aes(x = poverty, y = reorder(stato, poverty), fill= stato)) +
  geom_bar(stat = "identity",show.legend = FALSE) +
  scale_fill_manual(values=c("#73F069","#73F069","#73F069", "#FDF610","#73F069","#73F069",
                             "#6973F0","#73F069","#73F069","#73F069","#73F069",
                             "#73F069","#73F069","#73F069"))+
